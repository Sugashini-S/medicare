        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          >
            <div className="rounded-[40px] overflow-hidden shadow-2xl border-4 border-white">
              <img
                src="https://images.pexels.com/photos/5206923/pexels-photo-5206923.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Healthcare team at home"
        ...
        <section className="bg-background-light rounded-[40px] p-8 md:p-16 border border-border overflow-hidden relative">
          <div className="relative z-10">
            <div className="mb-12">
              <img
                src={aboutBanner}
                alt="Spondon Doorstep Healthcare"
